          ...
          {clients.map((client) => (
            <tr key={client._id}>
              ...
              <td>
                ...
                <button className="update" onClick={() => ToggleButton(client._id, 'client')}>Update</button>
                <button className="delete" onClick={() => ToggleButton(client._id, 'client')}>Delete</button>
