        ...
        <Grid item xs={12} sm={6} md={4} key={trainer._id}>
          <Card 
            ...
            <CardContent style={{flexGrow:1,display:'flex',flexDirection:'column'}}>
              <Typography variant="h5" gutterBottom>{trainer.username || trainer.email}</Typography>
              ...
              <div style={{ padding: '16px', textAlign: 'center' }}>
                <Button variant="contained" color="primary" fullWidth style={{height:'40px',fontWeight:'bold'}}>View Profile</Button>
              </div>
            </CardContent>
          </Card>
        </Grid>
