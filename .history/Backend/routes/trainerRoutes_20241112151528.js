...
router.get('/trainers', async (req, res) => {
  try {
    const trainers = await Trainer.find(); // Retrieve all trainers from the Trainer collection
    res.status(200).json(trainers); // Send back the list of trainers as JSON
  } catch (err) {
